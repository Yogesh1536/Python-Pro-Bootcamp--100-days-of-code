...
class FlightSearch:
    ...
    def find_flights(self, origin, destination, date_from, date_to):
        ...
        try:
            ...
            # in case no direct flight was found, try again with one stopover
            ...
            try:
                ...
                # some feedback
                print(f"Found a flight to {flight.destination_city} for {flight.price} {CURRENCY} with a stopover.")
                return flight
        else:
            flight = fd.FlightData(
                origin_city=data["route"][0]["cityFrom"],
            ...
            print(f"Found a direct flight to {flight.destination_city} for {flight.price} {CURRENCY}.")
            return flight
